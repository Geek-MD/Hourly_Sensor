...
- Remove the service integration classification so each configured sensor is
  displayed as an integration entry, matching HA Daily Counter.

## [v0.3.4] - 2026-08-18

### Changed

- Present each configuration as an integration entry instead of claiming the
